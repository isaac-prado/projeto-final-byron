            ...
            <div className="flex-col w-full">
                <div className="md:grid md:grid-cols-3">
                    ...
                    <div className="text-center md:text-left md:mt-12 mt-4 md:col-span-2 ">
                        <p className="text-2xl font-semibold text-marrom_escuro md:mb-4">A história do Abílio</p>
                        ...
                        <p className="mt-4 text-2xl font-semibold text-marrom_escuro md:mb-4">Mais informações sobre Abílio</p>
                        <div className="m-5">
                     {cardList.map(card => (
