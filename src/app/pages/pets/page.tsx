        ...
        <div className="flex-col w-full">
            <div>
                ...
                <div className="font-bold pt-5">
                    <div>
                        <p className="flex gap-2"><img src="./footer/pin-de-localizacao.png" alt="" />Itajubá, MG</p>
                    </div>
                    <div className="mt-2 ml-1">
                    <p className="flex gap-2"><img src="./footer/homem-usuario.png" alt="" />Publicado por Solidaripatas</p>
                    </div>
                </div>
                ...
                <div className="text-center font-semibold mt-4">
                    <p className="text-2xl text-marrom_escuro">Mais detalhes sobre Aurélio</p>
                </div>
