          ...
          <div className="flex flex-col space-y-4 px-4 py-8 sm:px-5 justify-center h-screen items-center border rounded bg-cinza"> 
            <h2 className="text-marrom_escuro text-4xl">Faça seu login</h2>
              <form action='private/inicial' method='POST'>
                  ...
                  <a href="./private/inicial"></a><input type="submit" value="Entrar" className=" text-xl flex h-10 w-full items-center justify-center rounded-md border text-sm transition-all focus:outline-none border-rosa bg-rosa text-black hover:bg-white hover:text-rosa"/>
